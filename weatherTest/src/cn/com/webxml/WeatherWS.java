 ...
 * 2018-03-04T14:58:41.265+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "WeatherWS", 
                  wsdlLocation = "D:/weather.wsdl",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = WeatherWS.class.getResource("D:/weather.wsdl");
        if (url == null) {
            url = WeatherWS.class.getClassLoader().getResource("D:/weather.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "D:/weather.wsdl");
        }       
        WSDL_LOCATION = url;
    }
