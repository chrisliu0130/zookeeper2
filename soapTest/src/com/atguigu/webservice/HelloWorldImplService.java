 ...
 * 2018-03-04T14:17:41.472+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", 
                  wsdlLocation = "http://localhost:9999/WSTest?wsdl",
...
public class HelloWorldImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9999/WSTest?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9999/WSTest?wsdl");
        }
        WSDL_LOCATION = url;
    }
